...
public class ReconnaissanceAuditiveEndActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Set Content **/
        setContentView(R.layout.activity_rec_auditive_end);
        ...
        buttonTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReconnaissanceAuditiveEndActivity.this, ReconnaissanceAuditiveActivity.class);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReconnaissanceAuditiveEndActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
